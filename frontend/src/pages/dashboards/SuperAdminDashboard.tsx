...
const BackupIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-full h-full">
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.125a3.375 3.375 0 01-3.375 3.375H7.75a3.375 3.375 0 01-3.375-3.375L3.75 7.5m16.5 0h-16.5m16.5 0V6a2.25 2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 6v1.5" />
  </svg>
);
...
const ReportsIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-full h-full">
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5A3.375 3.375 0 0010.125 2.25H9.75" />
  </svg>
);

const BillingIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-full h-full">
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5M3.75 20.25h16.5" />
  </svg>
);
...
const superTabs = [
  { id: 'system_control', label: 'System & Load Overview', icon: <OverviewIcon /> },
  { id: 'users', label: 'Users Directory', icon: <UsersIcon /> },
  { id: 'facilities', label: 'Facility Management', icon: <FacilityIcon /> },
  { id: 'ai_models', label: 'AI LLM Models', icon: <ModelsIcon /> },
  { id: 'security', label: 'Security & Access', icon: <SecurityIcon /> },
  { id: 'backups', label: 'System Backups', icon: <BackupIcon /> },
  { id: 'database', label: 'Database Monitoring', icon: <DatabaseIcon /> },
  { id: 'broadcast', label: 'Global Broadcast', icon: <BroadcastIcon /> },
  { id: 'audit', label: 'Audit & Compliance', icon: <AuditIcon /> },
  { id: 'reports', label: 'Reports & Analytics', icon: <ReportsIcon /> },
  { id: 'billing', label: 'Subscription & Billing', icon: <BillingIcon /> },
...
export default function SuperAdminDashboard() {
  ...
  // Map Hover Node State
  const [hoveredNode, setHoveredNode] = useState<{ city: string; val: number; load: string } | null>(null);
  ...
  const handleRunBackup = () => {
    ...
    setTimeout(() => {
      ...
      alert("System database backup completed successfully!");
    }, 1000);
  };

  const handleBroadcast = (e: React.FormEvent) => {
    e.preventDefault();
    alert(`Global alert broadcasted successfully to "${broadcastForm.target}".`);
      ...
      {isLoading ? <p className="text-xs text-secondary/60">Loading metrics...</p> : error ? <p className="text-red-500 text-xs">Error loading data</p> : (
        <div className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-xs text-secondary/70 font-semibold mt-1">Here's the comprehensive system architecture and server load metrics overview.</p>
                </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
                <div className="p-4 bg-white rounded-2xl shadow-clay border border-accent/30 flex flex-col justify-between">
                  <div>
                    <h3 className="text-[10px] font-bold text-secondary uppercase tracking-wider">Registered System Users</h3>
                    <p className="text-2xl font-extrabold text-dark mt-1">12,856</p>
                  </div>
                  <span className="text-[9px] text-[#00BFA6] font-bold mt-2">+18.6% vs last month</span>
                </div>

                <div className="p-4 bg-white rounded-2xl shadow-clay border border-accent/30 flex flex-col justify-between">
                  <div>
                    <h3 className="text-[10px] font-bold text-secondary uppercase tracking-wider">Total Facility Indexes</h3>
                    <p className="text-2xl font-extrabold text-dark mt-1">8,542</p>
                  </div>
                  <span className="text-[9px] text-[#00BFA6] font-bold mt-2">+12.3% vs last month</span>
                </div>

                <div className="p-4 bg-white rounded-2xl shadow-clay border border-accent/30 flex flex-col justify-between">
                  <div>
                    <h3 className="text-[10px] font-bold text-secondary uppercase tracking-wider">System Server Health</h3>
                    <p className="text-2xl font-extrabold text-green-500 mt-1">99.9%</p>
                  </div>
                  <span className="text-[9px] text-green-600 font-bold mt-2">Uptime status</span>
                </div>

                <div className="p-4 bg-white rounded-2xl shadow-clay border border-accent/30 flex flex-col justify-between">
                  <div>
                    <h3 className="text-[10px] font-bold text-secondary uppercase tracking-wider">Security Anomaly Alerts</h3>
                    <p className="text-2xl font-extrabold text-red-500 mt-1">3</p>
                  </div>
                  <span className="text-[9px] text-red-500 font-bold mt-2">-25% vs last month</span>
                </div>

                <div className="p-4 bg-white rounded-2xl shadow-clay border border-accent/30 flex flex-col justify-between">
                  <div>
                    <h3 className="text-[10px] font-bold text-secondary uppercase tracking-wider">Database Size</h3>
                    <p className="text-2xl font-extrabold text-dark mt-1">2.45 TB</p>
                  </div>
                  <span className="text-[9px] text-[#00BFA6] font-bold mt-2">+120 GB vs last month</span>
                </div>

                {/* Active Sessions Highlight Card */}
                <div className="p-4 bg-[#00BFA6]/10 text-secondary rounded-2xl shadow-clay border border-[#00BFA6]/20 flex flex-col justify-between">
                  <div>
                    <div className="flex items-center gap-1.5">
                      ...
                      <h3 className="text-[10px] font-bold uppercase tracking-wider text-[#00a892]">Active Sessions</h3>
                    </div>
                    <p className="text-2xl font-extrabold mt-1 text-dark">245</p>
                  </div>
                  <span className="text-[9px] text-secondary font-bold mt-2">Live users online</span>
                </div>
              </div>

              {/* Middle Line Chart, India Map, and Audit logs row */}
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                
                {/* Left Line Chart: System Load */}
                <div className="p-5 bg-white rounded-2xl shadow-clay border border-accent/30 lg:col-span-5 flex flex-col justify-between">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xs font-bold uppercase text-dark tracking-wider">System Load Average (Real-time)</h3>
                  ...
                  <div className="h-48 w-full">
                    <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={[
                        ...
                        <Area type="monotone" dataKey="load" stroke="#00BFA6" strokeWidth={3.5} fillOpacity={1} fill="url(#colorLoad)" />
                      </AreaChart>
                    </ResponsiveContainer>
                  </div>
                  {/* Load Metrics */}
                  <div className="grid grid-cols-4 gap-2 border-t border-accent/20 pt-4 mt-2 text-center">
                    <div>
                      <span className="text-[9px] text-secondary/60 font-semibold block">CPU Usage</span>
                      <span className="text-xs font-extrabold text-dark">42%</span>
                    </div>
                    <div>
                      <span className="text-[9px] text-secondary/60 font-semibold block">Memory Usage</span>
                      <span className="text-xs font-extrabold text-dark">68%</span>
                    </div>
                    <div>
                      <span className="text-[9px] text-secondary/60 font-semibold block">Disk Usage</span>
                      <span className="text-xs font-extrabold text-dark">32%</span>
                    </div>
                    <div>
                      <span className="text-[9px] text-secondary/60 font-semibold block">Network I/O</span>
                      <span className="text-xs font-extrabold text-dark">234 Mbps</span>
                    </div>
                  </div>
                </div>

                {/* Center System Map: India Outline */}
                <div className="p-5 bg-white rounded-2xl shadow-clay border border-accent/30 lg:col-span-4 flex flex-col justify-between relative">
                  ...
                  <div className="w-full flex items-center justify-center py-2 relative">
                    ...
                    {hoveredNode && (
                      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark/95 text-white p-3 rounded-xl shadow-2xl border border-secondary text-left space-y-1 z-30 pointer-events-none w-44 backdrop-blur-sm">
                        <p className="font-extrabold text-[10px] text-white">{hoveredNode.city}</p>
                        <p className="text-[9px] text-secondary-light font-semibold">Load status: <span className={`font-bold ${hoveredNode.load.includes('High') ? 'text-red-400' : hoveredNode.load.includes('Medium') ? 'text-orange-400' : 'text-green-400'}`}>{hoveredNode.load}</span></p>
                        <p className="text-[9px] text-white/80">Active Sessions: <span className="font-bold text-white text-xs">{hoveredNode.val}</span></p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex items-center justify-around text-[9px] font-bold text-secondary/80 border-t border-accent/20 pt-3">
                    <div className="flex items-center gap-1.5">
                      <span className="w-2 h-2 rounded-full bg-[#FF4D4D]"></span><span>High Load</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <span className="w-2 h-2 rounded-full bg-[#FF9500]"></span><span>Medium</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <span className="w-2 h-2 rounded-full bg-[#4CD964]"></span><span>Normal</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <span className="w-2 h-2 rounded-full bg-[#00BFA6]"></span><span>Low Load</span>
                    </div>
                  </div>
                </div>

                {/* Right Column: Active Audit Logs */}
                <div className="p-5 bg-white rounded-2xl shadow-clay border border-accent/30 lg:col-span-3 flex flex-col justify-between">
                  <div className="flex items-center justify-between mb-3.5">
                    <h3 className="text-xs font-bold uppercase text-dark tracking-wider">Active Audit Logs</h3>
                    <button 
                  ...
                  <div className="space-y-3.5 overflow-y-auto max-h-60 pr-1">
                    {[
                      { id: 1, text: "User 'admin_smith' updated facility 'City Hospital'.", time: '09:41 AM', type: 'info' },
                      { id: 2, text: "Backup completed successfully.", time: '09:32 AM', type: 'info' },
                      { id: 3, text: "New user 'dr_jones' registered.", time: '09:15 AM', type: 'info' },
                      { id: 4, text: "Role 'HospitalAdmin' modified.", time: '08:45 AM', type: 'info' },
                      { id: 5, text: "Failed login attempt from IP 192.168.1.5 (Rate Limited).", time: '08:30 AM', type: 'error' }
                    ].map((log) => (
                      <div key={log.id} className={`p-2.5 border rounded-xl flex gap-2 items-start text-[11px] ${
                        log.type === 'error' ? 'bg-red-50 border-red-200 text-red-800' : 'bg-accent/15 border-accent/20'
                      }`}>
                        <div className="space-y-0.5">
                          <p className="font-semibold leading-snug">
                            <span className="text-secondary/75 mr-1 font-bold">[{log.time}]</span>
                            {log.text}
                          </p>
                        </div>
                      </div>
              ...
              {/* Lower-Middle Usage, Alerts checklist, and Backup donut row */}
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                
                {/* Top 5 Facilities Usage Table */}
                <div className="p-5 bg-white rounded-2xl shadow-clay border border-accent/30 lg:col-span-6 flex flex-col justify-between">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xs font-bold uppercase text-dark tracking-wider">Top 5 Facilities by System Usage</h3>
                    <button 
                    ...
                    <table className="w-full text-left border-collapse min-w-[500px]">
                      <thead>
                        <tr className="border-b border-accent/15 text-secondary/70 text-[10px] uppercase font-bold tracking-wider">
                          <th className="py-2 px-1">Facility Name</th>
                          <th className="py-2 px-1">Type</th>
                          <th className="py-2 px-1 text-center">Users</th>
                          <th className="py-2 px-1">CPU Usage</th>
                          <th className="py-2 px-1">Memory Usage</th>
                          <th className="py-2 px-1 text-center">Status</th>
                        </tr>
                      </thead>
                      <tbody className="text-[11px] text-dark font-medium">
                        {[
                          { name: 'City Hospital', type: 'Hospital', users: '1,256', cpu: 72, mem: 68, status: 'Online' },
                          { name: 'District Health Center', type: 'Health Center', users: '845', cpu: 48, mem: 60, status: 'Online' },
                          { name: 'Community Clinic', type: 'Clinic', users: '532', cpu: 35, mem: 42, status: 'Online' },
                          { name: 'Rural PHC', type: 'PHC', users: '412', cpu: 28, mem: 35, status: 'Online' },
                          { name: 'Specialty Hospital', type: 'Hospital', users: '1,089', cpu: 65, mem: 70, status: 'Online' },
                        ].map((fac, idx) => (
                          <tr key={idx} className="border-b border-accent/15 hover:bg-accent/10">
                            <td className="py-2 px-1 font-bold">{fac.name}</td>
                            <td className="py-2 px-1 text-secondary/80">{fac.type}</td>
                            <td className="py-2 px-1 text-center font-bold">{fac.users}</td>
                            <td className="py-2 px-1 w-28">
                              <div className="flex items-center gap-1.5">
                                <span className="w-6 text-[9px] font-bold text-secondary">{fac.cpu}%</span>
                                <div className="flex-1 h-1.5 bg-accent/20 rounded-full overflow-hidden">
                                  <div className="h-full bg-secondary rounded-full" style={{ width: `${fac.cpu}%` }}></div>
                                </div>
                              </div>
                            </td>
                            <td className="py-2 px-1 w-28">
                              <div className="flex items-center gap-1.5">
                                <span className="w-6 text-[9px] font-bold text-secondary">{fac.mem}%</span>
                                <div className="flex-1 h-1.5 bg-accent/20 rounded-full overflow-hidden">
                                  <div className="h-full bg-[#00BFA6] rounded-full" style={{ width: `${fac.mem}%` }}></div>
                                </div>
                              </div>
                            </td>
                            <td className="py-2 px-1 text-center">
                              <span className="px-1.5 py-0.5 bg-green-100 text-green-700 rounded font-black text-[9px] uppercase">{fac.status}</span>
                            </td>
                          </tr>
                        ))}
                      </tbody>
                ...
                {/* System Alerts Checklist (center) */}
                <div className="p-5 bg-white rounded-2xl shadow-clay border border-accent/30 lg:col-span-3 flex flex-col justify-between">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xs font-bold uppercase text-dark tracking-wider">System Alerts & Notifications</h3>
                    <button 
                  ...
                  <div className="space-y-3.5">
                    {[
                      { id: 1, label: 'High Server Load', count: 2, status: 'high' },
                      { id: 2, label: 'Database Replication Delay', count: 1, status: 'warning' },
                      { id: 3, label: 'SSL Certificate Expiring', count: 3, status: 'warning' },
                      { id: 4, label: 'Pending Security Updates', count: 5, status: 'info' },
                      { id: 5, label: 'Inactive Users (30+ days)', count: 18, status: 'info' },
                    ].map((alert) => (
                      <div key={alert.id} className="flex justify-between items-center text-[11px] font-bold text-dark">
                        <div className="flex items-center gap-2">
                          <span className={`w-2 h-2 rounded-full ${
                            alert.status === 'high' ? 'bg-red-500' : alert.status === 'warning' ? 'bg-[#FF9500]' : 'bg-[#4CD964]'
                          }`}></span>
                          <span>{alert.label}</span>
                        </div>
                        <span className={`px-2 py-0.5 rounded font-black text-[9px] ${
                          alert.status === 'high' ? 'bg-red-100 text-red-750' : 'bg-accent text-secondary'
                        }`}>{alert.count}</span>
                      </div>
                    ))}
                  </div>
                ...
                {/* Backup & Recovery Status Donut chart (right) */}
                <div className="p-5 bg-white rounded-2xl shadow-clay border border-accent/30 lg:col-span-3 flex flex-col justify-between">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-xs font-bold uppercase text-dark tracking-wider">Backup & Recovery Status</h3>
                    <button onClick={() => setActiveTab('backups')} className="text-[10px] text-secondary font-bold hover:underline">View All</button>
                  </div>
                  <div className="flex items-center justify-center h-32 relative">
                    ...
                    <div className="absolute text-center">
                      <span className="text-sm font-black text-dark block leading-none">85%</span>
                      <span className="text-[8px] text-secondary/60 font-bold block mt-0.5">Successful</span>
                    </div>
                  </div>
                  <div className="flex justify-between text-[9px] font-bold text-secondary/80 border-t border-accent/20 pt-3">
                    <span className="flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-[#4CD964]"></span> Successful: 85%</span>
                    <span className="flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-[#FF4D4D]"></span> Failed: 5%</span>
                    <span className="flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-[#FF9500]"></span> Progress: 10%</span>
                  </div>
                </div>

              </div>

              {/* Bottom Footer Component widgets grid */}
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                
                {/* User Role Distribution */}
                <div className="p-4 bg-white rounded-2xl shadow-clay border border-accent/30 flex flex-col justify-between">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-[10px] font-extrabold uppercase text-dark tracking-wider">User Role Distribution</h3>
                    <button onClick={() => setActiveTab('users')} className="text-[9px] text-secondary font-bold hover:underline">View All</button>
                  </div>
                    ...
                    <div className="relative w-16 h-16 shrink-0">
                      <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                          <Pie
                            data={[
                              { name: 'HospitalAdmin', value: 19 },
                              { name: 'Doctor', value: 33 },
                              { name: 'Staff', value: 24 },
                              { name: 'Patient', value: 17 },
                              { name: 'Other', value: 7 },
                            ]}
                            cx="50%"
                            cy="50%"
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-[9px] font-black text-dark">12.8k</span>
                      </div>
                    </div>
                    <div className="space-y-0.5 text-[8px] font-bold text-secondary/80 leading-normal">
                      <p className="flex items-center gap-1 text-dark"><span className="w-1.5 h-1.5 rounded-full bg-secondary"></span> Admin: 19%</p>
                      <p className="flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-[#4CD964]"></span> Doctor: 33%</p>
                      <p className="flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-[#FF9500]"></span> Staff: 24%</p>
                      <p className="flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-[#FF4D4D]"></span> Patient: 17%</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-white rounded-2xl shadow-clay border border-accent/30 flex flex-col justify-between">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-[10px] font-extrabold uppercase text-dark tracking-wider">System Services Status</h3>
                    <button onClick={() => alert("Services logs redirection...")} className="text-[9px] text-secondary font-bold hover:underline">View All</button>
                  </div>
                  <div className="space-y-1.5 text-[9.5px] font-bold text-secondary/80">
                    {[
                      { label: 'Authentication Service', status: 'Healthy' },
                      { label: 'Database Service', status: 'Healthy' },
                      { label: 'AI LLM Service', status: 'Healthy' },
                      { label: 'Notification Service', status: 'Healthy' },
                      { label: 'File Storage Service', status: 'Healthy' },
                    ].map((srv, idx) => (
                      <div key={idx} className="flex justify-between items-center">
                        <span>{srv.label}</span>
                        <span className="text-green-600 font-extrabold flex items-center gap-1">
                          <span className="w-1 h-1 rounded-full bg-green-600"></span>{srv.status}
                        </span>
                      </div>
                    ))}
                  </div>
                ...
                <div className="p-4 bg-white rounded-2xl shadow-clay border border-accent/30 flex flex-col justify-between">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-[10px] font-extrabold uppercase text-dark tracking-wider">Recent System Activities</h3>
                    <button onClick={() => alert("Activities log...")} className="text-[9px] text-secondary font-bold hover:underline">View All</button>
                  </div>
                  <div className="space-y-2.5 overflow-y-auto max-h-32 text-[9.5px] font-semibold text-secondary/80">
                    {[
                      { text: 'System backup completed', time: '10 mins ago' },
                      { text: "New hospital 'Green Valley' added", time: '25 mins ago' },
                      { text: 'User role updated: dr_anna', time: '1 hour ago' },
                      { text: "AI model 'MedLens-v2' deployed", time: '2 hours ago' },
                    ].map((act, idx) => (
                      <div key={idx} className="flex justify-between items-center border-b border-accent/10 pb-1">
                        <span className="text-dark font-bold truncate max-w-[140px]">{act.text}</span>
                        <span className="text-[8px] text-secondary/50 font-medium shrink-0">{act.time}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="p-4 bg-white rounded-2xl shadow-clay border border-accent/30 flex flex-col justify-between">
                  <h3 className="text-[10px] font-extrabold uppercase text-dark tracking-wider mb-2.5">Quick Actions</h3>
                  <div className="grid grid-cols-4 gap-1.5">
                    {[
                      { icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235A8.902 8.902 0 0110 18a8.902 8.902 0 016 1.235" /></svg>, label: 'Add User', tab: 'users' },
                      { icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg>, label: 'Add Facility', tab: 'facilities' },
                      { icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 7.5l-.625 10.125a3.375 3.375 0 01-3.375 3.375H7.75a3.375 3.375 0 01-3.375-3.375L3.75 7.5m16.5 0h-16.5m16.5 0V6a2.25 2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 6v1.5" /></svg>, label: 'Sys Backup', action: handleRunBackup },
                      { icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M19.114 5.636a9 9 0 010 12.728M16.463 8.288a5.25 5.25 0 010 7.424M6.75 8.25l4.72-4.72a.75.75 0 011.28.53v15.88a.75.75 0 01-1.28.53l-4.72-4.72H4.51c-.88 0-1.704-.507-1.938-1.354A9.01 9.01 0 012.25 12" /></svg>, label: 'Alert Broadcast', tab: 'broadcast' },
                      { icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>, label: 'Roles Admin', tab: 'security' },
                      { icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125" /></svg>, label: 'Reports', tab: 'reports' },
                      { icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.28" /></svg>, label: 'Settings', tab: 'settings' },
                      { icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>, label: 'Clear Cache', action: () => alert("Cache cleared successfully!") },
                    ].map((btn, idx) => (
                      <button 
                        key={idx}
                        onClick={() => btn.action ? btn.action() : btn.tab && setActiveTab(btn.tab)}
                        className="p-1 bg-accent/20 hover:bg-[#00BFA6]/10 rounded-xl flex flex-col items-center justify-center gap-1 text-center text-secondary transition-all"
                      >
                        {btn.icon}
                        <span className="text-[7.5px] font-bold leading-tight truncate w-full">{btn.label}</span>
                      </button>
                    ))}
                  </div>
                </div>
          ...
          {activeTab === 'users' && (
            <div className="p-6 bg-white rounded-2xl shadow-clay border border-accent/30 space-y-6">
              <div className="flex justify-between items-center flex-wrap gap-4">
                <div>
                  <h3 className="text-base font-extrabold text-dark">System User Registrations</h3>
                  <p className="text-[11px] text-secondary/60 mt-1">Audit log tracking active user levels and profile details.</p>
                </div>
          ...
          {activeTab === 'security' && (
            <div className="p-6 bg-white rounded-2xl shadow-clay border border-accent/30 space-y-6">
              <div>
                <h3 className="text-base font-extrabold text-dark">Security & Access Audits</h3>
                <p className="text-[11px] text-secondary/60 mt-1">Review active firewalls, failed login thresholds, and API keys validation.</p>
              </div>
              <div className="space-y-4 text-xs font-bold text-secondary">
                <div className="flex justify-between items-center border-b border-accent/15 pb-3">
                  <div>
                    <p className="text-dark">Strict IP Rate Limiting</p>
                    <p className="text-[10px] text-secondary/60 font-medium">Prevent brute force login attempts from malicious addresses.</p>
                  </div>
                  <input type="checkbox" defaultChecked className="w-4 h-4 text-secondary accent-secondary" />
                </div>
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-dark">Two-Factor Authentication (2FA)</p>
                    <p className="text-[10px] text-secondary/60 font-medium">Require all administrative roles to login via verification keys.</p>
                  </div>
                  <input type="checkbox" defaultChecked className="w-4 h-4 text-secondary accent-secondary" />
                </div>
              </div>
          ...
          {activeTab === 'backups' && (
            <div className="p-6 bg-white rounded-2xl shadow-clay border border-accent/30 space-y-6">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-base font-extrabold text-dark">SQLite Database Snapshots</h3>
                  <p className="text-[11px] text-secondary/60 mt-1">Manage database backup snapshots and file recovery operations.</p>
                </div>
                <button 
          ...
          {/* ======================================================== */}
          {/* TAB 7: DATABASE MONITORING                               */}
          {/* ======================================================== */}
          {activeTab === 'database' && (
            <div className="p-6 bg-white rounded-2xl shadow-clay border border-accent/30 space-y-6">
              <div>
                <h3 className="text-base font-extrabold text-dark">Database Monitoring Portal</h3>
                <p className="text-[11px] text-secondary/60 mt-1">Storage metrics, indexing profiles, and database query latency charts.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs text-dark font-medium">
                <div className="p-4 border border-accent/20 bg-accent/10 rounded-2xl space-y-1">
                  <p className="text-secondary/70">Database Engine</p>
                  <p className="text-base font-extrabold text-dark">SQLite v3.x</p>
                </div>
                <div className="p-4 border border-accent/20 bg-accent/10 rounded-2xl space-y-1">
                  <p className="text-secondary/70">Read Latency</p>
                  <p className="text-base font-extrabold text-secondary">1.2ms (Avg)</p>
                </div>
                <div className="p-4 border border-accent/20 bg-accent/10 rounded-2xl space-y-1">
                  <p className="text-secondary/70">Write Latency</p>
                  <p className="text-base font-extrabold text-secondary">3.4ms (Avg)</p>
                </div>
              </div>
            </div>
          )}
          ...
          {/* ======================================================== */}
          {/* TAB 8: GLOBAL BROADCAST                                  */}
          {/* ======================================================== */}
          {activeTab === 'broadcast' && (
            <div className="p-6 bg-white rounded-2xl shadow-clay border border-accent/30 space-y-4 max-w-xl">
              <div>
                <h3 className="text-base font-extrabold text-dark">Broadcast Global Bulletin Alert</h3>
                <p className="text-[11px] text-secondary/60 mt-1">Broadcast system maintenance alerts or instructions globally.</p>
              </div>
              <form onSubmit={handleBroadcast} className="space-y-4 text-xs">
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full h-24 p-3 bg-accent/20 border-none rounded-xl focus:ring-2 focus:ring-secondary resize-none outline-none"
                    required
                  />
                </div>

                <button type="submit" className="px-6 py-2 bg-secondary text-white font-bold rounded-xl shadow hover:bg-[#00a892] transition-colors">
                  📢 Broadcast Alert
                </button>
              </form>
            </div>
          ...
          {activeTab === 'audit' && (
            <div className="p-6 bg-white rounded-2xl shadow-clay border border-accent/30 space-y-6">
              <div>
                <h3 className="text-base font-extrabold text-dark">Audit & Compliance Reports</h3>
                <p className="text-[11px] text-secondary/60 mt-1">Review activity records to ensure medical platform data compliance.</p>
              </div>
              <div className="space-y-3.5">
                {[
                  { time: '12:45 PM', role: 'Doctor', act: "User 'doc_yusuf' logged in successfully." },
                  { time: '12:30 PM', role: 'DistrictAdmin', act: "'district_yusuf' generated PDF report." },
                  { time: '11:15 AM', role: 'System', act: "Failed login attempt from IP 192.168.1.5 (Rate Limited)." }
                ].map((aud, idx) => (
                  <div key={idx} className="p-3.5 border border-accent/15 rounded-xl bg-accent/5 flex justify-between items-center text-xs">
                    <div>
                      <p className="font-bold text-dark">{aud.act}</p>
                      <p className="text-[9px] text-secondary/60">Time logged: {aud.time}</p>
                    </div>
                    <span className="px-2.5 py-0.5 bg-secondary/15 text-secondary rounded font-bold text-[9px]">{aud.role}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          {activeTab === 'reports' && (
            <div className="p-6 bg-white rounded-2xl shadow-clay border border-accent/30 space-y-6">
              <div>
                <h3 className="text-base font-extrabold text-dark">System Reports & Analytics</h3>
                <p className="text-[11px] text-secondary/60 mt-1">Compile administrative logs, usage graphs, and database snapshots.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 border border-accent/30 rounded-xl flex justify-between items-center bg-accent/10">
                  <div>
                    <h4 className="font-bold text-xs text-dark">Monthly Server Load report</h4>
                    <p className="text-[10px] text-secondary/60 mt-1">Compiled response times, CPU peaks, and database read profiles.</p>
                  </div>
                  <button onClick={() => alert("Downloading PDF...")} className="px-3.5 py-1.5 bg-secondary text-white text-xs font-bold rounded-lg shadow hover:bg-[#00a892]">Export</button>
                </div>
              </div>
            </div>
          )}
          ...
          {/* ======================================================== */}
          {/* TAB 11: SUBSCRIPTION & BILLING                            */}
          {/* ======================================================== */}
          {activeTab === 'billing' && (
            <div className="p-6 bg-white rounded-2xl shadow-clay border border-accent/30 space-y-6">
              <div>
                <h3 className="text-base font-extrabold text-dark">Subscription & Billing Logs</h3>
                <p className="text-[11px] text-secondary/60 mt-1">Monitor billing tiers, payments status, and invoice parameters for facilities.</p>
              </div>
              <div className="p-4 border border-accent/20 bg-accent/10 rounded-2xl text-xs space-y-1 font-bold text-secondary">
                <p className="text-dark">Commercial Tier: Active</p>
                <p className="text-[10px] font-medium">Billed: 1st of every month • Invoices up-to-date</p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'integrations' && (
            <div className="p-6 bg-white rounded-2xl shadow-clay border border-accent/30 space-y-6">
              <div>
                <h3 className="text-base font-extrabold text-dark">External API Integrations</h3>
                <p className="text-[11px] text-secondary/60 mt-1">Monitor third-party integrations, webhook registrations, and medical data feeds.</p>
              </div>
              <div className="p-4 border border-accent/20 bg-accent/10 rounded-2xl text-xs space-y-1.5 font-bold">
                <p className="text-dark flex items-center justify-between">SMS Gateway Integration <span className="text-green-600 font-extrabold text-[10px] uppercase">Active</span></p>
                <p className="text-dark flex items-center justify-between">FHIR Medical Feeds API <span className="text-green-600 font-extrabold text-[10px] uppercase">Active</span></p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'settings' && (
            <div className="p-6 bg-white rounded-2xl shadow-clay border border-accent/30 space-y-6">
              <div>
                <h3 className="text-base font-extrabold text-dark">System Configuration Settings</h3>
                <p className="text-[11px] text-secondary/60 mt-1">Configure threshold variables, backup intervals, and AI LLM temperature settings.</p>
              </div>
              <div className="space-y-4 text-xs font-bold text-secondary">
                <div className="flex justify-between items-center border-b border-accent/15 pb-3">
                  <div>
                    <p className="text-dark">Auto System Backup</p>
                    <p className="text-[10px] text-secondary/60 font-medium">Trigger automatic database snapshot backups every 24 hours.</p>
                  </div>
                  <input type="checkbox" defaultChecked className="w-4 h-4 text-secondary accent-secondary" />
                </div>
              </div>
